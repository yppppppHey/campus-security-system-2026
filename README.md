...
| 登录页面 | 仪表盘 | 数据管理 | 安全审计 |
| :---: | :---: | :---: | :---: |
| ![登录页面](images/login.png) | ![仪表盘](images/dashboard.png) | ![数据管理](images/data.png) | ![安全审计](images/audit.png) |
...
© 2026 数据安全课程设计
=======
# campus-security-system-2026
校园多源敏感数据一体化安全防护系统，实现RBAC权限控制、国密SM4加密、差分隐私保护、数据脱敏、安全审计等核心安全功能，基于Flask实现Web管理界面。
>>>>>>> 050b2bbd2826c93e3275ce9719ec2170278cb981
